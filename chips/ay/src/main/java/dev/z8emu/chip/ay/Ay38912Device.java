...
public final class Ay38912Device implements TimedDevice, PcmMonoSource {
    ...
    public synchronized void setPortAReadProvider(IntSupplier provider) {
    ...
    public synchronized int readSelectedRegister() {
        return switch (selectedRegister) {
            case PORT_A_REGISTER -> portAReadProvider.getAsInt() & 0xFF;
            case PORT_B_REGISTER -> portBReadProvider.getAsInt() & 0xFF;
            default -> registers[selectedRegister] & 0xFF;
        };
    }
