...
const AREAS = {
  ...
  'machine-c64': { scope: 'machines/c64 apps/desktop/src/main/java/dev/z8emu/app/desktop/C64*.java', hint: 'Largest: C64VideoDeviceTest.java (856), C64RomProbeLauncher.java (760, operational probe tool), C64SidDevice.java (586), C64VideoDevice.java (415), C64CiaDevice.java (339). ~5.7k lines. The machine landed in sequential phases (docs/commodore-64-plan.md) — look for phase leftovers: helpers duplicated between renderer passes, scaffolding a later phase obsoleted, overlapping launcher options. Frame/audio CRC baselines are locked in tests and smokes; fixes must keep output bit-identical. Test files: reuse+simplification only.', angles: ['reuse', 'simplification', 'efficiency', 'altitude'] },
