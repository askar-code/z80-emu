...
public final class BeeperDevice implements TimedDevice {
    ...
    private short mixedOutputLevel() {
        ...
        if (earBit) {
            return micBit ? LEVEL_EAR_1_MIC_1 : LEVEL_EAR_1_MIC_0;
        }
        return micBit ? LEVEL_EAR_0_MIC_1 : LEVEL_EAR_0_MIC_0;
    }
