...
public record SpectrumModelConfig(
    ...
    public static SpectrumModelConfig spectrum48k() {
        return new SpectrumModelConfig(
                ...
                14_335,
                224,
                SpectrumUlaDevice.SCANLINES_PER_FRAME,
                SpectrumUlaDevice.FLOATING_BUS_DISPLAY_START_48K,
                SpectrumUlaDevice.FIRST_DISPLAY_PIXEL_TSTATE_48K,
                1,
                3,
                16 * 1024,
                0,
    ...
    public static SpectrumModelConfig spectrum128() {
        return new SpectrumModelConfig(
                ...
                228,
                311,
                SpectrumUlaDevice.FLOATING_BUS_DISPLAY_START_128K,
                SpectrumUlaDevice.FIRST_DISPLAY_PIXEL_TSTATE_128K,
                2,
                8,
                16 * 1024,
                5,
